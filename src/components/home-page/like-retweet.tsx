...
export default function LikeRewteet({ post }: { post: any }) {
    ...
    return <div className="flex gap-5">
        <div className="flex gap-1">
            <svg className={post.likes.length > 0 ? "fill-red-700" : ""} width="20px" height="20px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex gap-1">
            <svg className={post.retweets.length > 0 ? "fill-red-700" : ""} width="20px" height="20px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                <title>retweet</title>
